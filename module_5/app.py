...
data via SQL statmenets and display the results on a Flask home page"""
...
@app.route("/")
def home():
    """Method defines a home page using Flask
              creates a connection to a databse and a cursor connection
              initializes variable query with a desired SQL statement
              executes SQL statement
              stores desired data in respective variables
              renders a template home page with the data gathered from the database """
    ...
    return render_template('base.html',
                           num_fall2024_applicants= num_fall2024_applicants,
